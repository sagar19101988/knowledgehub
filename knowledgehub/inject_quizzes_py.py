...
if target in content:
    new_content = content.replace(target, raw_quizzes + "\\n" + target)
    with open('src/data/quizzes.ts', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("Success! Injected Tier 2 Quizzes into quizzes.ts")
else:
